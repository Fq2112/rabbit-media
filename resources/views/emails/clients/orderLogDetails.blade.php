                                                    ...
                                                    <tr>
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <strong style="font-size: 22px">Berikut adalah rincian
                                                                    kemajuan pesanan Anda</strong><br>
                                                                {{$log->deskripsi}}
                                                            </small>
                                                        </td>
                                                    </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="alert alert-warning text-center">
                                                    @if($log->isReady == true)
                                                        Permintaan revisi pesanan dapat dilakukan pada halaman
                                                ...
                                                <table border="0" cellpadding="10" cellspacing="0"
                                                    ...
                                                    @if($log->isReady == true)
                                                        <tr>
                                                            <td>
                                                                <small style="line-height: 2em">
                                                                    <strong style="font-size: 20px">Untuk melakukan
                                                                        permintaan revisi pesanan Anda, silahkan klik
                                                                        tombol "REVISION NOW" berikut.</strong>
                                                                </small>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" width="600" class="full-width"
                                                                ...
                                                                <a class="zoom" id="activate"
                                                                   ...
                                                                   ($log->pemesanan_id),'invoice'=> $invoice,
                                                                   'status' => 'revision'])}}"
                                                                   target="_blank">REVISION NOW</a>
                                                            </td>
                                                        </tr>
                                                    @else
                                                        <tr>
                                                            <td>
                                                                <small style="line-height: 2em">
                                                                    ...
                                                                    Untuk beralih ke halaman tersebut, silahkan klik
                                                                    tombol Order Status berikut.
                                                                </small>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="center" width="600" class="full-width"
                                                                ...
                                                                <a class="zoom" id="activate" target="_blank"
                                                                   href="{{route('client.dashboard')}}">ORDER STATUS</a>
                                                            </td>
                                                        </tr>
                                                    @endif
                                                </table>
