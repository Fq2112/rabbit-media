...
<div class="card profile-widget">
    <div class="profile-widget-header">
        ...
        <div class="profile-widget-items">
            <div class="profile-widget-item">
                ...
                <div class="profile-widget-item-value" id="orders" data-toggle="tooltip" title="Order Managed"
                     data-placement="bottom">{{$admin->getOrderLog != null ? $admin->getOrderLog->count() : 0}}</div>
            </div>
            <div class="profile-widget-item">
                <div class="profile-widget-item-label">Member Since</div>
                <div class="profile-widget-item-value">{{\Carbon\Carbon::parse($admin->created_at)->format('j F Y')}}</div>
            </div>
            <div class="profile-widget-item">
    ...
    <div class="card-footer">
        <div class="font-weight-bold mb-2">Follow {{\Illuminate\Support\Str::words($admin->name, 1, '')}} On</div>
