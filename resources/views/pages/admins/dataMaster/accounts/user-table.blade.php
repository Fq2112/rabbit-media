                                    ...
                                    @foreach($users as $user)
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle" align="center">
                                                <div class="custom-checkbox custom-control">
                                                    <input type="checkbox" id="cb-{{$user->id}}"
                                                           class="custom-control-input dt-checkboxes">
                                                    <label for="cb-{{$user->id}}"
                                                           class="custom-control-label">{{$no++}}</label>
                                                </div>
                                            </td>
                                            <td style="vertical-align: middle" align="center">{{$user->id}}</td>
                                            <td style="vertical-align: middle" align="center">
...
@push("scripts")
    ...
    <script>
        ...
        $(function () {
            var export_filename = 'Users Table ({{now()->format('j F Y')}})', table = $("#dt-buttons").DataTable({
                ...
                fnDrawCallback: function (oSettings) {
                    ...
                    $('.btn_massDelete').on("click", function () {
                        ...
                        $("#form-user input[name=user_ids]").val(ids);
                        $("#form-user").attr("action", "{{route('massDelete.users')}}");
