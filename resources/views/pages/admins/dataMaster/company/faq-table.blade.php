                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    @foreach($faqs as $faq)
                                        <tr>
                                            <td style="vertical-align: middle" align="center">
                                                <div class="custom-checkbox custom-control">
                                                    <input type="checkbox" id="cb-{{$faq->id}}"
                                                           class="custom-control-input dt-checkboxes">
                                                    <label for="cb-{{$faq->id}}"
                                                           class="custom-control-label">{{$no++}}</label>
                                                </div>
                                            </td>
                                            <td style="vertical-align: middle" align="center">{{$faq->id}}</td>
                                ...
                                <form method="post" id="form-mass">
                                    {{csrf_field()}}
                                    <input type="hidden" name="faq_ids">
                                </form>
                            </div>
                        </div>
                    </div>
...
@push("scripts")
    ...
    <script>
        $(function () {
            var export_filename = 'FAQS Table ({{now()->format('j F Y')}})', table = $("#dt-buttons").DataTable({
                ...
                fnDrawCallback: function (oSettings) {
                    ...
                    $('.btn_massDelete').on("click", function () {
                        ...
                        $("#form-mass input[name=faq_ids]").val(ids);
                        $("#form-mass").attr("action", "{{route('massDelete.faqs')}}");
