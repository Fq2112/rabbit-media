...
@section('title', 'The Rabbits: Account Settings | Rabbit Media – Digital Creative Service')
@push('styles')
        ...
        <div class="section-body">
            ...
            <div class="row mt-sm-4">
                <div class="col-12 col-md-12 col-lg-6">
                    @include('layouts.partials.auth._form_ava-admin')
                </div>
                <div class="col-12 col-md-12 col-lg-6">
                    <div class="card">
                        <form action="{{route('admin.update.account')}}" method="post" id="form-as">
                            {{csrf_field()}}
                            {{method_field('PUT')}}
