...
@push("scripts")
    ...
    <script>
        ...
        function editOutcome(id, pemesanan_id, invoice, item, ed_qty, ed_price_per_qty, ed_price_total, encryptID) {
            ...
            $(".add-field").prop('disabled', false).hide();
            ...
            $("#inputs").html(
                ...
                '<input id="item' + id + '" type="text" class="form-control" name="item" value="' + item + '" ' +
                ...
                '<input id="qty' + id + '" type="text" class="form-control" name="qty" ' +
                'value="' + thousandSeparator(qty) + '" placeholder="0" onkeyup="checkQty(' + id + ')" required>' +
                '<input id="price_per_qty' + id + '" type="text" class="form-control" name="price_per_qty" required ' +
                'value="' + thousandSeparator(price_per_qty) + '" placeholder="0" onkeyup="checkPricePerQty(' + id + ')">' +
        ...
        $(".add-field").on("click", function () {
            ...
            $("#inputs").append(
                ...
                '<div class="input-group-prepend">' +
                '<span class="input-group-text"><i class="fa fa-shopping-cart"></i></span></div>' +
                '<input id="item' + i + '" type="text" class="form-control" name="item[]" ' +
                'placeholder="Write the item\'s name here&hellip;" required></div></div></div>' +
                '<div class="row">' +
                '<div class="col">' +
                '<label class="m-0">Total Qty & Price/pcs (IDR)</label>' +
                '<div class="input-group">' +
                '<div class="input-group-prepend"><span class="input-group-text"><strong>@</strong></span></div>' +
                '<input id="qty' + i + '" type="text" class="form-control" name="qty[]" ' +
                'placeholder="0" onkeyup="checkQty(' + i + ')" required>' +
                '<input id="price_per_qty' + i + '" type="text" class="form-control" name="price_per_qty[]" ' +
                'placeholder="0" onkeyup="checkPricePerQty(' + i + ')" required>' +
                '<div class="input-group-append">' +
                '<span class="input-group-text"><i class="fa fa-money-bill-wave"></i></span></div></div></div>' +
                '<div class="col"><label class="m-0">Total Price</label>' +
                '<div class="input-group">' +
