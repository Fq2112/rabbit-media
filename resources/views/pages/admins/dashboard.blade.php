...
@push('styles')
    <link rel="stylesheet" href="{{asset('admins/modules/jqvmap/dist/jqvmap.min.css')}}">
    <link rel="stylesheet" href="{{asset('admins/modules/weather-icon/css/weather-icons.min.css')}}">
    <link rel="stylesheet" href="{{asset('admins/modules/weather-icon/css/weather-icons-wind.min.css')}}">
                        ...
                        <ul class="list-unstyled list-unstyled-border">
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                     src="{{asset('admins/img/avatar/avatar-1.png')}}" alt="avatar">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                     src="{{asset('admins/img/avatar/avatar-2.png')}}" alt="avatar">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                     src="{{asset('admins/img/avatar/avatar-3.png')}}" alt="avatar">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="mr-3 rounded-circle" width="50"
                                     src="{{asset('admins/img/avatar/avatar-4.png')}}" alt="avatar">
                                <div class="media-body">
                        ...
                        <div class="row pb-2">
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="{{asset('admins/img/avatar/avatar-5.png')}}" class="img-fluid"
                            ...
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="{{asset('admins/img/avatar/avatar-4.png')}}" class="img-fluid"
                            ...
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="{{asset('admins/img/avatar/avatar-1.png')}}" class="img-fluid"
                            ...
                            <div class="col-6 col-sm-3 col-lg-3 mb-4 mb-md-0">
                                <div class="avatar-item mb-0">
                                    <img alt="image" src="{{asset('admins/img/avatar/avatar-2.png')}}" class="img-fluid"
                    ...
                    <div class="card-body">
                        <ul class="list-unstyled list-unstyled-border">
                            ...
                            <li class="media">
                                ...
                                <img class="mr-3 rounded-circle" width="50"
                                     src="{{asset('admins/img/avatar/avatar-5.png')}}" alt="avatar">
                                <div class="media-body">
...
@push('scripts')
    <script src="{{asset('admins/modules/simple-weather/jquery.simpleWeather.min.js')}}"></script>
    <script src="{{asset('admins/modules/chart.min.js')}}"></script>
    <script src="{{asset('admins/modules/jqvmap/dist/jquery.vmap.min.js')}}"></script>
    <script src="{{asset('admins/modules/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
    ...
    <script src="{{asset('admins/js/page/index-0.js')}}"></script>
@endpush